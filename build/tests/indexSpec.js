...
describe('Server', () => {
    it('return a file jpg with status 200', () => __awaiter(void 0, void 0, void 0, function* () {
        yield (0, supertest_1.default)(index_1.default)
            .get('/api/images?filename=fjord&width=200&heigh=200')
            .expect(200)
            .expect('Content-Type', 'image/jpg');
    }));
    it('return bad request with wrong width', () => __awaiter(void 0, void 0, void 0, function* () {
        yield (0, supertest_1.default)(index_1.default)
            .get('/api/images?filename=fjord&width=test&heigh=200')
            .expect(400, "Width is wrong. Please type input is number");
    }));
    it('return bad request with wrong heigh', () => __awaiter(void 0, void 0, void 0, function* () {
        yield (0, supertest_1.default)(index_1.default)
